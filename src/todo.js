...
const addTaskBtn = document
  ...
  .addEventListener("click", () => {
    ...
    ul.addEventListener("click", (event) => {
      if(event.target.id === "delete-edit-opener"){
        document.getElementById("delete-edit-section").classList.toggle("hidden")
        document.getElementById("delete-edit-section").classList.toggle("flex")
      }
    })
    ...
    ul.addEventListener("click", (event) => {
      if (event.target.id === "edit-btn") {
        ...
        if (listItem) {
          ...
          document.getElementById("edit-task-name-input").value = currentTaskName;
          document.getElementById("edit-task-desc-input").value = currentTaskDesc;
    ...
    document
      ...
      .addEventListener("click", () => {
        const taskNameInput = document.getElementById("edit-task-name-input").value;
        ...
        if (taskNameInput !== "" && taskDescInput !== "" && currentListItem) {
          currentListItem.querySelector("h3").innerText = taskNameInput;
          currentListItem.querySelector("p.text-gray-400").innerText = taskDescInput;

          document.getElementById("edit-task-name-input").value = "";
    ...
    document.addEventListener("click", (event) => {
      if (!editSection.contains(event.target) && event.target.id !== "edit-btn" && !editSection.classList.contains("hidden")) {
        editSection.classList.add("hidden");
        currentListItem = null;
      }
    });
